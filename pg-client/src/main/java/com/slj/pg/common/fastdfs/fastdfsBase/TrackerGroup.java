...
public class TrackerGroup {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(TrackerGroup.class);

    /**
     * Constructor
     * @param tracker_servers tracker servers
     */
    public TrackerGroup(InetSocketAddress[] tracker_servers,int networkTimeout,int connectTimeout) {
    ...
    public TrackerServer getConnection(int serverIndex) throws IOException {
        ...
        sock.connect(this.tracker_servers[serverIndex], connectTimeout);
        return new TrackerServer(sock, this.tracker_servers[serverIndex],networkTimeout,connectTimeout);
    }
