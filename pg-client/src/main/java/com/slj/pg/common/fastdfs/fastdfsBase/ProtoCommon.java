...
public class ProtoCommon {
    ...
    private static final byte FDFS_PROTO_CMD_QUIT = 82;
    ...
    public static RecvHeaderInfo getRecvHeader(InputStream in, byte expect_cmd,long expect_body_len) throws IOException {
        RecvHeaderInfo header = recvHeader(in, expect_cmd, expect_body_len);
        return header;
    }
